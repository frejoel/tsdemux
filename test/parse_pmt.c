...
void parse_pmt_data(void)
{
    ...
    test_assert_equal(memcmp(pmt.descriptors[0].data, &data[6], 3), 0, "descriptor data 1");
    ...
    test_assert_equal(memcmp(pmt.descriptors[1].data, &data[11], 2), 0, "descriptor data 2");
    ...
    test_assert_equal(memcmp(pmt.program_elements[0].descriptors[0].data, &data[20], 1), 0, "program element descriptor data 1");
    ...
    test_assert_equal(memcmp(pmt.program_elements[1].descriptors[0].data, &data[28], 3), 0, "program element 2 descriptor data 1");
